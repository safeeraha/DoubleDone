  ...
  <body>
      ...
      <div class="container">
        ...
        >
          ...
          <h2 class="h3 mb-3 font-weight-normal text-dark"><strong></strong> Login</h2>
          ...
          <a href="register.php" class="btn btn-success" type="submit">Register</a>
      ...
      <div class="row footer-box" style="margin-top:240px;">
